                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <span class="font-size-12"><a href="{{url('/amanagepettycash',$data->id)}}">OO{{$data->id}}</a></span>
                                            </td>
                                            <td>
                                                <span class="font-size-12"><a href="{{url('/amanagepettycash',$data->id)}}">{{$data->requestedby}}</a></span>
                                            </td>
