                    ...
                    <ul class="nav-right">
                        ...
                        <li class="dropdown dropdown-animated scale-left">
                            ...
                            <div class="p-b-15 p-t-20 dropdown-menu pop-profile">
                                ...
                                <a href="{{ url('/agentprofile') }}" class="dropdown-item d-block p-h-15 p-v-10">
                                ...
                                <a href="{{ url('/agenteditprofile') }}" class="dropdown-item d-block p-h-15 p-v-10">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div>
                                ...
                                <form id="logout-form" action="{{ route('logout') }}" method="POST" class="dropdown-item d-block p-h-15 p-v-10">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div>
                                            ...
                                            <span class="m-l-10" onclick="event.preventDefault();
